    ...
    public class LoginViewModel : ViewModelBase
    {
        ...
        private async Task<bool> ImplLogin(IProgress<int> progress, CancellationToken ct)
        {
            ...
            return await Task.Run(async () =>
            {
                ...
                model.RememberPassoword = this.IsRememberPwd;
                model.AutoLogin = this.IsAutoLogin;

                WorkItemContainer.Instance.Register("User", model);
                GlobalService.Resolve<IPropertyService>().Set("Client", new ClientConfig());
                GlobalService.Resolve<IPropertyService>().Set("User", model);
                GlobalService.Resolve<IPropertyService>().Save();
        ...
        private void ShowMainWindow()
        {
            ...
            WorkItemContainer.Instance.Raise("ShowMainWindow");
        }
