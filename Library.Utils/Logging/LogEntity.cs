...
namespace WD.Library.Logging
{
    ...
    public sealed class LogEntity : ICloneable
    {
        ...
        {
            return $"[MachineName]:{MachineName},[StackTrace]:{StackTrace},[Source]:{Source},[Message]:{Message}";
        }

        ///// <summary>
        ///// 修改日志记录的Message
        ///// </summary>
        ///// <param name="newMessage">新Message</param>
        public void ChangeMessage(string newMessage)
        {
            ExceptionHelper.CheckStringIsNullOrEmpty(message, "日志记录信息不能为空");
