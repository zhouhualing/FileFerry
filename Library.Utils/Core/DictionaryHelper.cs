...
namespace WD.Library.Core
{
	...
	public static class DictionaryHelper
	{
		...
		/// <returns></returns>
		public static TReturnValue GetValue<TKey, TValue, TReturnValue>(IDictionary<TKey, TValue> dict, TKey key, TReturnValue defaultValue)
		{
		...
		/// <param name="defaultValue">如果不存在key时，返回的缺省值</param>
		/// <returns></returns>
		public static TReturnValue GetValue<TReturnValue>(IDictionary dict, object key, TReturnValue defaultValue)
		{
			TReturnValue result = defaultValue;
		...
		public static bool AddNonDefaultValue<TKey, TValue>(IDictionary<TKey, TValue> dict, TKey key, TValue data)
		{
			ExceptionHelper.FalseThrow<ArgumentNullException>(dict != null, "dict");
			bool added = false;
		...
		/// <returns>是否添加了该项</returns>
		public static bool AddNonDefaultValue<TKey, TValue>(IDictionary<TKey, TValue> dict, TKey key, TValue data, TValue defaultValue)
		{
			ExceptionHelper.FalseThrow<ArgumentNullException>(dict != null, "dict");
			bool added = false;
