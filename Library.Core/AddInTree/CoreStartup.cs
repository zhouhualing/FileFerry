...
{
	/// <summary>
	/// Class that helps starting up WD.Library.Core.
	/// </summary>
	/// <remarks>
	/// Initializing WD.Library.Core requires initializing several static classes
	...
	public sealed class CoreStartup
	{
        ...
        public void RunInitialization()
		{
			...
			if (container != null)
				addInTree.BuildItems<object>("/Application/Services", container, false);

            // run workspace autostart commands
            ////LoggingService.Info("Running autostart commands...");
            //foreach (ICommand command in addInTree.BuildItems<ICommand>("/Application/Autostart", null, false)) {
            //	try {
