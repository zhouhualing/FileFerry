...
namespace WD.Library.Data
{
    ...
    public abstract class Database
    {
        ...
        {
            this.name = name;
            //this.factory = DbConnectionManager.GetDbProviderFactory(this.name); 
        ...
        #region UpdateDataSet 面向批量处理增加的方法
            ...
            object value)
        {
            ...
            //parameter.Size = size;//TODO hualing
        ...
        public IList<T> CovertDateTableToList<T>(DataTable dataTable) where T : class
        {
